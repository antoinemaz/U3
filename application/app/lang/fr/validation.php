...
"InputNom" => "Nom",
"InputPrenom" => "Prénom",
"InputDateNaissance" => "Date de naissance",
"InputLieu" => "Lieu de naissance",
"InputTel" => "Téléphone",
"InputAdr" => "Adresse",
"InputVille" => "Ville",
"InputCP" => "Code postal",
"InputNatio" => "Nationalité",
"InputPays" => "Pays",
"filiere" => "Filière",
"InputAnnee" => "Année",
"InputSexe" => "Sexe",
"InputDateDernDiplome" => "Date du dernier diplome",
"annee" => "Année",
"etablissement" => "Etablissement",
"diplome" => "Diplome",
"moyenne_annee" => "Moyenne de l'année",
"mention" => "Mention",
"rang" => "Rang",
